...
import { createSupplierOrderArticlesSchema } from "@/schemas";
import { useSupplierParts } from "../providers/supplierPartsProvider";

export const UpdateSupplierArticlesActionsColumn = ({ orderPart }: any) => {
  const { name, price, notes, quantity } = orderPart.data;
    ...
    >
      ...
      >
        <Box
          ...
          onClick={() => handleRemoveArticle(name)}
        >
